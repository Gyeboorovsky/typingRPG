...
export const CLASSES: Record<ClassId, ClassDef> = {
  warrior: {
    ...
    hpRegen: 2, hpRegenCombat: 0.5, mpRegen: 3,
  ...
  ninja: {
    ...
    hpRegen: 2, hpRegenCombat: 0.5, mpRegen: 3.5,
  ...
  wizard: {
    ...
    hpRegen: 2, hpRegenCombat: 0.5, mpRegen: 4,
  ...
  priest: {
    ...
    hpRegen: 2.5, hpRegenCombat: 1, mpRegen: 5,
